class Mention < ActiveRecord::Base
	...
	# TODO: we currently do not know WHO, specifically,
	# 		mentioned a person -- we only know his potential sponsors
	...
	validates_uniqueness_of :mentionable_id, scope: [:mentionable_type, :year, :deleted_at]
